...
def test_followers_to_score_log(followers):
    actual_score = assessment.followers_to_score_log(followers)
...
def test_inDayCommits(inDayCommits,day_work ):
    ...
    score = assessment.inDayCommits_to_score_log(inDayCommits, coefficient_inDayCommits, max_value_inDayCommitsRepo)
