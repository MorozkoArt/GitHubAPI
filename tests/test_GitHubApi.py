...
from src.app.StartMethods.M_Start_UserAssessment_generation import (start_assessment_generation
...
@pytest.mark.parametrize("my_token, login,  var_kod",
                         [(my_token, "Lucik19", 1),
                          (my_token, "Sahil0101", 1),
                          (my_token, "Arun953", 1),
                          (my_token, "ProNinjaDev", 1),
                          (my_token, "MorozkoArt", 1),
                          (my_token, "Tulen4ick", 1),
                          (my_token, "ArtemFedorov2004", 1)])
